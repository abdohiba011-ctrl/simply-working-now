    ...
    <div className="relative flex min-h-screen w-full bg-muted/20">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        {showUnverifiedBanner && !isLocked && (
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-amber-300 bg-amber-50 px-4 py-2 lg:px-8 dark:bg-amber-900/30">
            ...
            <Button
              size="sm"
              variant="outline"
              className="h-8 border-amber-400 text-amber-900 hover:bg-amber-100 dark:text-amber-100"
        ...
        {isTrialing && daysLeftInTrial !== null && (
          <div
            className="flex flex-wrap items-center justify-between gap-3 border-b px-4 py-2 lg:px-8"
          ...
          >
            ...
            <Button
              ...
              className="h-8 bg-[#163300] text-white hover:bg-[#163300]/90"
            >
              Upgrade now
            </Button>
          </div>
      ...
      {/* Whole-shell lock overlay covering sidebar + header + content */}
      {isLocked && (
